...
void basic_metaobject::put_in_cache(hnd_t hnd)
{
    ...
    mng->used_cache_size[i] += hnd->obj->size; 
...
{
    commit_transaction(transaction_manager::get());
}
...
void basic_metaobject::commit_transaction(transaction_manager* mng) { 
...
void optimistic_metaobject::end_read(hnd_t hnd)
{
    ...
    if (--mng->n_nested_transactions == 0) {
        ...
        if (mng->exception_count != 0) { 
            abort_transaction(NULL, aborted_by_user);
        } else
#endif
        commit_transaction();
    }
...
void transient_metaobject::commit_transaction() {}
void transient_metaobject::destroy(hnd_t) {}
void transient_metaobject::end_read(hnd_t) {}
void transient_metaobject::end_transaction() {}
