...
class GOODS_DLL_EXPORT HTTPapi : public WWWapi { 
  protected:
    ...
    virtual boolean handlePut(WWWconnection& con, char* header, char* host,
                              big_body& content);
    virtual boolean handlePut(WWWconnection& con, char* header, char* host,
  ...
  public:
    ...
    char *BinaryPatternSearch (char* iStart, char* iEnd, 
                               char *iPattern, size_t iPatternSize);
    char *extractTokenValue (char *Token, char *start, char *end);
    ...
    //--------------------------------------------------------------------------
    int   ReadMultipartData (WWWconnection& con, char *iHeader, char *iHost,
